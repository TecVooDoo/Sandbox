...
namespace AmplifyShaderPack
{
	...
	public class DoCreateASPReadme : AssetCreationEndAction
	{
	...
	public class ASPReadmeEditor : Editor
	{
	...
	#if UNITY_6000_4_OR_NEWER
		static EntityId GetAssetID( ASPReadme asset )
		{
			return asset.GetEntityId();
		}
	#else
		static int GetAssetID( ASPReadme asset )
		{
		...
		static void CreateASPReadmeBuiltin()
		{
			...
			ProjectWindowUtil.StartNameEditingIfProjectWindowExists( GetAssetID( asset ), endNameEditAction, "Readme.asset"/*assetPathAndName*/, AssetPreview.GetMiniThumbnail( asset ), null );
		}
