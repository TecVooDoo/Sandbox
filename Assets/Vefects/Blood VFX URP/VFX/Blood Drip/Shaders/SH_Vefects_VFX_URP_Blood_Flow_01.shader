...
Shader "Vefects/SH_Vefects_VFX_URP_Blood_Flow_01"
{
	Properties
	{
		...
		_BloodTextureUVScale("Blood Texture UV Scale", Vector) = (1,1,0,0)
		_BloodTexturePanSpeed("Blood Texture Pan Speed", Vector) = (3,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			float2 _BloodTexturePanSpeed;
			float2 _BloodTextureUVScale;
			float _ZTest;
			float _DepthFade;
			float _OpacityMult;
			float _Smoothness;
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord296 = input.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner299 = ( 1.0 * _Time.y * _BloodTexturePanSpeed + ( texCoord296 * _BloodTextureUVScale ));
				float4 tex2DNode288 = tex2D( _BloodTexture, panner299 );
				float2 temp_cast_1 = (( ( tex2DNode288.g * _LUTScale ) + _LUTOffset )).xx;
				float4 baseCol291 = tex2D( _LUT, temp_cast_1 );
				float4 temp_output_308_0 = ( float4( (input.ase_color).rgb , 0.0 ) * baseCol291 );
				
				float3 lerpResult235 = lerp( float3(0,0,1) , (tex2D( _BloodTextureNormal, panner299 )).rgb , _NormalIntensity);
				float3 norm100 = lerpResult235;
				
				float3 temp_cast_5 = (_Specular).xxx;
				
				float smoothstepResult292 = smoothstep( 0.0 , ( 0.0 + 0.1 ) , tex2DNode288.g);
				float opa293 = smoothstepResult292;
				...
				float op62 = saturate( ( saturate( ( saturate( ( ( saturate( opa293 ) * _OpacityMult ) * distanceDepth36 ) ) * saturate( cameraDepthFade111 ) ) ) * input.ase_color.a ) );
				

				float3 BaseColor = temp_output_308_0.rgb;
				float3 Normal = norm100;
				float3 Emission = ( temp_output_308_0 * _EmissionIntensity ).rgb;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 texCoord296 = input.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner299 = ( 1.0 * _Time.y * _BloodTexturePanSpeed + ( texCoord296 * _BloodTextureUVScale ));
				float4 tex2DNode288 = tex2D( _BloodTexture, panner299 );
				float smoothstepResult292 = smoothstep( 0.0 , ( 0.0 + 0.1 ) , tex2DNode288.g);
				float opa293 = smoothstepResult292;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 texCoord296 = input.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner299 = ( 1.0 * _Time.y * _BloodTexturePanSpeed + ( texCoord296 * _BloodTextureUVScale ));
				float4 tex2DNode288 = tex2D( _BloodTexture, panner299 );
				float2 temp_cast_1 = (( ( tex2DNode288.g * _LUTScale ) + _LUTOffset )).xx;
				float4 baseCol291 = tex2D( _LUT, temp_cast_1 );
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 texCoord296 = input.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner299 = ( 1.0 * _Time.y * _BloodTexturePanSpeed + ( texCoord296 * _BloodTextureUVScale ));
				float3 lerpResult235 = lerp( float3(0,0,1) , (tex2D( _BloodTextureNormal, panner299 )).rgb , _NormalIntensity);
				float3 norm100 = lerpResult235;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_TARGET
			{
				...
				float2 texCoord296 = input.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner299 = ( 1.0 * _Time.y * _BloodTexturePanSpeed + ( texCoord296 * _BloodTextureUVScale ));
				float4 tex2DNode288 = tex2D( _BloodTexture, panner299 );
				float smoothstepResult292 = smoothstep( 0.0 , ( 0.0 + 0.1 ) , tex2DNode288.g);
				float opa293 = smoothstepResult292;
...
Node;AmplifyShaderEditor.Vector2Node;298;-6400,-384;Inherit;False;Property;_BloodTextureUVScale;Blood Texture UV Scale;7;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TextureCoordinatesNode;296;-6784,-512;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;297;-6400,-512;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node;300;-5888,-384;Inherit;False;Property;_BloodTexturePanSpeed;Blood Texture Pan Speed;8;0;Create;True;0;0;0;False;0;False;3,0;3,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.PannerNode;299;-5888,-512;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TexturePropertyNode;289;-5376,-896;Inherit;True;Property;_BloodTexture;Blood Texture;6;0;Create;True;0;0;0;False;3;Space(33);Header(Texture);Space(13);False;2b2b83eb1f6f94a48876a72ef22c9d03;2b2b83eb1f6f94a48876a72ef22c9d03;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.SimpleAddOpNode;294;-3968,128;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode;292;-3840,-128;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;293;-3328,-128;Inherit;False;opa;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;301;-3200,-1408;Inherit;False;293;opa;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;116;-384,-1024;Inherit;False;Property;_CameraDepthFadeOffset;Camera Depth Fade Offset;14;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;115;-384,-1152;Inherit;False;Property;_CameraDepthFadeLength;Camera Depth Fade Length;13;0;Create;True;0;0;0;False;3;Space(33);Header(Camera Depth Fade);Space(13);False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;78;-3456,-2432;Inherit;True;Property;_BloodTextureNormal;Blood Texture Normal;9;0;Create;True;0;0;0;False;3;Space(33);Header(Normals);Space(13);False;d69ffd0533a6f524fb518ad7daac8b61;d69ffd0533a6f524fb518ad7daac8b61;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;33;-2304,640;Inherit;False;Property;_NormalDistortionIntensity;Normal Distortion Intensity;11;0;Create;True;0;0;0;False;0;False;0.25;0.25;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;26;-1280,-384;Inherit;False;Property;_Color01;Color 01;0;0;Create;True;0;0;0;False;3;Space(33);Header(Attributes);Space(13);False;1,1,1,0;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;237;-2688,-1792;Inherit;False;Property;_NormalIntensity;Normal Intensity;10;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;239;-992,-272;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ComponentMaskNode;302;-2944,-1888;Inherit;False;True;True;True;False;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;306;-4736,-384;Inherit;False;Property;_LUTScale;LUT Scale;16;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;305;-4352,-384;Inherit;False;Property;_LUTOffset;LUT Offset;17;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;307;-640,-768;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;308;-384,-512;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;295;-640,-512;Inherit;False;291;baseCol;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.ComponentMaskNode;309;-384,-768;Inherit;False;True;True;True;False;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;310;0,100;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=109588872813BC6A753D3CC578F2240581366063