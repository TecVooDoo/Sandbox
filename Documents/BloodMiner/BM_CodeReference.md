# Blood Miner -- Code Reference

**Purpose:** Script inventory and API reference for Blood Miner.
...
| BloodManager | Currency tracking (earn, spend, balance). Lifetime total for rank. | Done |
